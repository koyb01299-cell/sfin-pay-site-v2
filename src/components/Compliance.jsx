    ...
    >
      ...
      <motion.div {...fadeUp(0)} className="text-center max-w-3xl mx-auto mb-20">
        ...
        <h2 className="mt-8 text-4xl md:text-5xl font-extrabold text-[#1f1631] leading-relaxed tracking-tight">
          ...
          <span className="block mt-3">투명한 결제 인프라</span>
        </h2>

        <p className="mt-8 text-[#4b3a6b]/80 text-lg leading-relaxed">
          SFIN PAY는 전자금융거래법과 여신전문금융업법 등
          주요 금융 규제를 완벽히 준수하며,
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
        {[
          ...
          <motion.div
            key={i}
            {...fadeUp(i + 1)}
            className="group relative rounded-2xl border border-[#e2d6ff]/60 bg-white/90 p-7 hover:shadow-[0_10px_30px_rgba(124,58,237,0.12)] hover:border-[#cbbafc] transition-all duration-500"
          >
      ...
      <motion.div {...fadeUp(6)} className="max-w-4xl mx-auto mt-28 text-center">
        <h3 className="text-2xl font-bold text-[#2d1b55] mb-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8">
          {[
            ...
            <motion.div
              ...
              className="flex flex-col items-center gap-3 bg-gradient-to-b from-[#faf7ff] to-[#ffffff] p-6 rounded-xl border border-[#e2d6ff] shadow-[0_6px_20px_rgba(124,58,237,0.08)] w-[230px]"
            >
              <div className="p-3 rounded-full bg-[#8b5cf6]/10 text-[#7c3aed]">
                {item.icon}
              </div>
              <p className="text-sm font-medium text-[#2d1b55] leading-relaxed">
                {item.label}
              </p>
            </motion.div>
          ))}
      ...
      <motion.div
        {...fadeUp(8)}
        className="text-center max-w-3xl mx-auto mt-24 rounded-2xl border border-[#e2d6ff] bg-gradient-to-r from-[#f3ecff] to-[#ffffff] p-10 shadow-[0_6px_25px_rgba(124,58,237,0.08)]"
      >
        <p className="text-[#4b3a6b]/80 text-lg mb-8 leading-relaxed">
