  ...
  return (
    <div className="min-h-screen bg-[#faf8ff] text-[#1f1631] pt-32">
      ...
      <section className="text-center py-20 px-6 md:px-16 bg-gradient-to-b from-[#f9f6ff] to-[#faf8ff]">
        ...
        >
          외식업 매출 관리,{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6d28d9] via-[#7c3aed] to-[#a78bfa]">
            이제 자동으로
          </span>
        </motion.h1>
        <motion.p
      ...
      <section className="py-24 px-6 md:px-16 bg-[#f4f0ff] relative overflow-hidden">
        <motion.h2
          ...
          className="text-4xl font-bold text-center mb-12 text-[#1f1631]"
        >
          F&B 결제 흐름 한눈에 보기
        </motion.h2>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 text-center">
          ...
          >
            ...
            <p className="text-sm text-[#4b3a6b]/70">결제 발생</p>
          </motion.div>
        ...
        >
          결제 → 승인 → 정산 → 입금까지 모든 절차가 자동으로 연결됩니다.
          <br />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          {[
            ...
            },
            {
              icon: <Clock3 size={28} />,
              title: "빠른 입금 시스템",
              desc: "오늘 결제된 금액을 당일 또는 익일 바로 입금받으세요.",
            },
            {
              icon: <Zap size={28} />,
              title: "POS 교체 없이 연동",
      ...
      <section className="py-24 px-6 md:px-16 bg-gradient-to-tr from-[#f4e8ff] to-[#ede3ff] text-center">
        <motion.h2
          ...
          animate={{ opacity: mounted ? 1 : 0, y: mounted ? 0 : 20 }}
          transition={{ duration: 0.6 }}
          className="text-4xl font-bold mb-4 text-[#1f1631]"
        >
          결제부터 입금까지,{" "}
